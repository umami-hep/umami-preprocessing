...
- Check the documentation against the code, document the `transform` and `auto_counts` blocks and give the run docs a step by step walkthrough [#166](https://github.com/umami-hep/umami-preprocessing/pull/166)
- Always apply the `num_global_objects_estimate` fallbacks and reject non-positive values instead of failing later in the prepare stage [#166](https://github.com/umami-hep/umami-preprocessing/pull/166)
