...
- Make the log level configurable via `UPP_LOG_LEVEL` or `--log-level`, add timestamps to all log messages and write warnings and errors to stderr [#161](https://github.com/umami-hep/umami-preprocessing/pull/161)
